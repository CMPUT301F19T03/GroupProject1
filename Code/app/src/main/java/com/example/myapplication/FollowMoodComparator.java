...
public class FollowMoodComparator implements Comparator<FollowMood> {
    @Override
    /**
     ...
     * the nested if is to compare the time of each mood object if they are made on the same date.
     */
    public int compare(FollowMood m1, FollowMood m2){
